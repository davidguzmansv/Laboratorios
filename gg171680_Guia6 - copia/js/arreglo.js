...
//Agregamos el evento click a los botonoes, adicionalmente
//se le asigna la funcio  que realizar la operacion
...
function agregarElemento() {
    ...
    if (isNaN(numero)) {
        ...
        //Agreguemos un nuevo elemento al arreglo
        arreglo.push(numero);

        //Utilizaremos la API DOM para crear el elemento html
        ...
        //se utiliza beforend para insertar el nuevo
        //elemento dentro del idContainerArreglovy despues de su ultimo hijo
