//obtentiendo la referencia de los elementos
// por medoi de arreglos asociativos
// aqui se esta utilizadno el atributo name de cada elemento
...
const recorrerFormulario = function () {
    ...
    // Recorreindo elementos del forulario
    ...
    for(let index = 0; index< totalElementos; index++) {
        ...
        //contabilizando el total de INPUT TYOE = TEXT
        if(tipoElemento == "text" && tipoNode == "INPUT" ) {
            console.log(elemento);
            totText++;
        }
        //Contabilizando el total de INPUT TYOE = PASSWORD
